      ...
      <div className="mb-6">
        <div className="flex items-start justify-between mb-4">
          <div className="relative">
            <div className="absolute -inset-2 bg-gradient-to-r from-primary to-accent rounded-xl blur-lg opacity-20 group-hover:opacity-40 transition-opacity duration-500 animate-breathe"></div>
        ...
        <div className="flex flex-wrap gap-3">
          {links.github && (
            <a 
              ...
              target="_blank" 
              rel="noopener" 
              className="group/btn inline-flex items-center px-4 py-2 bg-foreground text-background rounded-lg hover:bg-primary hover:text-primary-foreground transition-all duration-300 font-semibold shadow-md hover:shadow-lg text-sm morph-button magnetic"
            >
          ...
          {links.docs && (
            <a 
              ...
              target="_blank" 
              rel="noopener" 
              className="group/btn inline-flex items-center px-4 py-2 bg-gradient-to-r from-primary to-accent text-white rounded-lg hover:shadow-lg transition-all duration-300 font-semibold shadow-md text-sm morph-button magnetic"
            >
          ...
          {links.live && (
            <a 
              ...
              target="_blank" 
              rel="noopener" 
              className="group/btn inline-flex items-center px-4 py-2 bg-gradient-to-r from-accent to-secondary text-white rounded-lg hover:shadow-lg transition-all duration-300 font-semibold shadow-md text-sm morph-button magnetic"
            >
